/** This is just for references the old statusactivity before refactored into fragments */
...
public class CopyOfStatusActivity extends Activity implements OnClickListener{
	...
	public final class PostTask extends //class in class example
		...
		protected void onPostExecute(String result) {
			...
			Toast.makeText(CopyOfStatusActivity.this, result, Toast.LENGTH_LONG).show();
		}
